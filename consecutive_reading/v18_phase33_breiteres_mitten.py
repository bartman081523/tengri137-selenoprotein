"""
v18_phase33_breiteres_mitten.py
V18 PHASE 33 — Breiteres Mitten-Rauschen (300-2500Hz)

LEHRE AUS PHASE 32:
- 27.4% 300-1000Hz (zu viel), 0% in 1000-3000Hz (ZU WENIG!)

NEUE STRATEGIE:
- Mitten-Rauschen 300-2500Hz (erweitert, füllt 1000-3000Hz)
- Centroid-Sinus reduziert
- Höhen-Rauschen erweitert
"""
import json
import sys
import numpy as np
...
def main():
    print("=" * 80)
    print("V18 PHASE 33 — Breiteres Mitten-Rauschen (300-2500Hz)")
    print("=" * 80)
    ...
    out_wav = out_dir / "synthese_v33_breit.wav"
    ...
    out_json = out_dir / "phase33_breit.json"
    output = {
        "phase": "V18 Phase 33 — Breites Mitten-Rauschen",
        "n_pass": n_pass,
        "n_tests": len(tests),
        "spektrum_r": float(r),
        ...
        "tests": tests,
        "verdict": f"V18 Phase 33: {n_pass}/{len(tests)} PASS. r={r:.3f}, wave_corr={wave_corr:.3f}, ratio={ratio:.3f}.",
    }
