"""
v18_phase38_phase36_plus_hohen.py
V18 PHASE 38 — Phase 36 Balance + Höhen-Boost

LEHRE AUS PHASE 36 + 37:
- Phase 36: max_diff 4.9% (T2 PASS), Sub-Bass -4.9%
- Phase 37: ratio 0.727 (BEST), Sub-Bass -12.9% (zu wenig)

KOMBINATION:
- Phase 36 Balance (Sub-Bass 0.30, MH 1.20) + Höhen 0.40
"""
import json
import sys
import numpy as np
...
def main():
    print("=" * 80)
    print("V18 PHASE 38 — Phase 36 + Höhen")
    print("=" * 80)
    ...
    # Phase 36 Balance + Höhen
    SUB_BASS_AMP = 0.30
    HARMONIC_AMP = 0.15
    MID_NOISE_AMP = 0.50
    MID_HIGH_NOISE_AMP = 1.20
    CENTROID_AMP = 0.20
    HIGH_AMP = 0.30  # boost von 0.20
    ...
    out_wav = out_dir / "synthese_v38_p36_plus_hohen.wav"
    ...
    out_json = out_dir / "phase38_p36_plus_hohen.json"
    output = {
        "phase": "V18 Phase 38 — Phase 36 + Höhen",
        "n_pass": n_pass,
        "n_tests": len(tests),
        "spektrum_r": float(r),
        ...
        "tests": tests,
        "verdict": f"V18 Phase 38: {n_pass}/{len(tests)} PASS. r={r:.3f}, wave_corr={wave_corr:.3f}, ratio={ratio:.3f}.",
    }
