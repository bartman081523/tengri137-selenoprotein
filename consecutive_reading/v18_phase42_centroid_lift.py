"""
v18_phase42_centroid_lift.py
V18 PHASE 42 — Phase 41 + Centroid-Sinus +0.10

LEHRE AUS PHASE 41:
- 3/5 PASS, max_diff 2.7% (BEST!)
- Centroid ratio 0.607

ZIEL: Centroid-Sinus 0.20 → 0.30 (hebt Centroid ratio)
"""
import json
import sys
import numpy as np
...
def main():
    print("=" * 80)
    print("V18 PHASE 42 — Phase 41 + Centroid-Sinus +0.10")
    print("=" * 80)
    ...
    out_wav = out_dir / "synthese_v42_centroid_lift.wav"
    ...
    out_json = out_dir / "phase42_centroid_lift.json"
    output = {
        "phase": "V18 Phase 42 — Phase 41 + Centroid",
        "n_pass": n_pass,
        "n_tests": len(tests),
        "spektrum_r": float(r),
        ...
        "tests": tests,
        "verdict": f"V18 Phase 42: {n_pass}/{len(tests)} PASS. r={r:.3f}, wave_corr={wave_corr:.3f}, ratio={ratio:.3f}.",
    }
