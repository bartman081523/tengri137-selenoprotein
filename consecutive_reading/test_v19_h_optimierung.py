"""
test_v19_h_optimierung.py
V19 PHASE 0h — H_sub30_mh200 weiter optimieren

BESTE BASIS: H_sub30_mh200 (3/6 PASS, r=0.723)
"""
import json
import sys
import numpy as np
...
def main():
    ...
    tests = [
        (0.30, 0.10, 0.20, 0.10, 2.00, 0.05, "H1"),
        (0.30, 0.10, 0.25, 0.10, 2.00, 0.05, "H2"),
        (0.30, 0.10, 0.15, 0.10, 2.50, 0.05, "H3_mh250"),
        (0.30, 0.10, 0.20, 0.10, 2.50, 0.05, "H4_mh250_v2"),
        (0.30, 0.10, 0.20, 0.10, 3.00, 0.05, "H5_mh300"),
        (0.30, 0.15, 0.20, 0.10, 2.00, 0.05, "H6_didg15"),
        (0.35, 0.10, 0.20, 0.10, 2.00, 0.05, "H7_sub35"),
        (0.25, 0.10, 0.20, 0.10, 2.00, 0.05, "H8_sub25"),
        (0.30, 0.10, 0.30, 0.10, 2.00, 0.05, "H9_vow30"),
        (0.30, 0.10, 0.20, 0.15, 2.00, 0.05, "H10_saw15"),
        (0.30, 0.10, 0.20, 0.20, 2.00, 0.05, "H11_saw20"),
        (0.30, 0.10, 0.20, 0.10, 2.00, 0.10, "H12_p2_10"),
    ]
    ...
    for sub, didg, vow, saw, mh, p2, name in tests:
        ...
        out_wav = out_dir / f"synthese_v19_h_{name}.wav"
