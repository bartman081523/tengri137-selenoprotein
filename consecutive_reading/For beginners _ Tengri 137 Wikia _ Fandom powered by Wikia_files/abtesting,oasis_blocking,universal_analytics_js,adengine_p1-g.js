...
(function(window,undefined){'use strict';if(!window.wgNoExternals){(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments);},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m);})(window,document,'script','//web.archive.org/web/20170108235250/http://www.google-analytics.com/analytics.js','ga');}else{window.ga=function(){};}
...
amznMatch.type='text/javascript';amznMatch.src='https://web.archive.org/web/20170108235250/http://c.amazon-adsystem.com/aax2/amzn_ads.js';amznMatch.addEventListener('load',function(){var renderAd=win.amznads.renderAd;if(!win.amznads.getAdsCallback||!renderAd){return;}
...
prebid.async=true;prebid.type='text/javascript';prebid.src=adContext.getContext().opts.prebidBidderUrl||'//web.archive.org/web/20170108235250/http://acdn.adnxs.com/prebid/prebid.js';node.parentNode.insertBefore(prebid,node);}
...
/*
     FILE ARCHIVED ON 23:52:50 Jan 08, 2017 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 12.92
  LoadShardBlock: 115.624 (3)
  PetaboxLoader3.datanode: 68.051 (5)
  PetaboxLoader3.resolve: 568.954 (3)
  load_resource: 555.685 (2)
*/