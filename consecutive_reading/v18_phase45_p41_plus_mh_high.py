"""
v18_phase45_p41_plus_mh_high.py
V18 PHASE 45 — Phase 41 + MH 1.20→1.40, Höhen 0.20→0.30

LEHRE AUS PHASE 41/43/44:
- 3/5 PASS, max_diff 2.7% (BEST)
- Centroid ratio 0.607 (ZU NIEDRIG)
- Phase 44 mit weniger Sub-Bass: ratio ÜBERSCHOSS auf 1.17

ZIEL: Sub-Bass konstant 0.35, MH-Rauschen +0.20, Höhen +0.10
"""
import json
import sys
import numpy as np
...
def main():
    print("=" * 80)
    print("V18 PHASE 45 — Phase 41 + MH +0.20, Höhen +0.10")
    print("=" * 80)
    ...
    out_wav = out_dir / "synthese_v45_p41_mh_high.wav"
    ...
    out_json = out_dir / "phase45_p41_mh_high.json"
    output = {
        "phase": "V18 Phase 45 — Phase 41 + MH/Höhen",
        "n_pass": n_pass,
        "n_tests": len(tests),
        "spektrum_r": float(r),
        ...
        "tests": tests,
        "verdict": f"V18 Phase 45: {n_pass}/{len(tests)} PASS. r={r:.3f}, wave_corr={wave_corr:.3f}, ratio={ratio:.3f}.",
    }
