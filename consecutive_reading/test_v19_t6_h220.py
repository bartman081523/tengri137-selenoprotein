"""
test_v19_t6_h220.py
V19 PHASE 11 — T6_H2_20 als Basis: r=0.776, max_diff=4.5%

T6_H2_20: sub=0.15, harm2=0.20, p2=0.20, didg=0.00, vow=0.20, saw=0.20, mh=3.30
   → r=0.776, ratio=0.871, max_diff=4.5%, 1-3k=8.7%
...
def main():
    ...
    print("T6 H2_20 OPTIMIERUNG (1-3k von 8.7% auf ≤ 8%)")
    ...
    tests = [
        # weniger MH
        (0.15, 0.20, 0.20, 0.20, 0.20, 3.20, "T1_MH320"),
        (0.15, 0.20, 0.20, 0.20, 0.20, 3.10, "T2_MH310"),
        (0.15, 0.20, 0.20, 0.20, 0.20, 3.00, "T3_MH300"),
        (0.15, 0.20, 0.20, 0.20, 0.20, 2.90, "T4_MH290"),
        # mehr H2 (hebt 1-3k)
        (0.15, 0.25, 0.20, 0.20, 0.20, 3.30, "T5_H2_25"),
        (0.15, 0.30, 0.20, 0.20, 0.20, 3.30, "T6_H2_30"),
        # weniger saw
        (0.15, 0.20, 0.20, 0.20, 0.15, 3.30, "T7_saw15"),
        (0.15, 0.20, 0.20, 0.20, 0.10, 3.30, "T8_saw10"),
        # weniger p2
        (0.15, 0.20, 0.15, 0.20, 0.20, 3.30, "T9_p2_15"),
        # mehr sub
        (0.20, 0.20, 0.20, 0.20, 0.20, 3.30, "T10_sub20"),
    ]
    ...
    for sub, harm2, p2, vow, saw, mh, name in tests:
        ...
        out_wav = out_dir / f"synthese_v19_t11_{name}.wav"
