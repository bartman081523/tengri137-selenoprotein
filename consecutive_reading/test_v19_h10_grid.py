"""
test_v19_h10_grid.py
V19 PHASE 25 — H10-Familie systematisch scannen

H10 (5/6): sub=0.20, harm2=0.25, p2=0.30, mh=3.50, 1500-3500
I8 (5/6): sub=0.20, harm2=0.25, p2=0.30, mh=3.50, 1500-3800

ZIEL: Optimale H10-Konfiguration + höchste r
"""
import json
import sys
import numpy as np
...
def main():
    ...
    print("H10-FAMILIE GRID-SCAN")
    print(f"{'Name':<35} {'r':<7} {'wave':<10} {'ratio':<7} {'diff':<8} {'0-100':<8} {'1-3k':<8}")
    print("-" * 100)

    # H10: sub=0.20, harm2=0.25, p2=0.30, mh=3.50, 1500-3500
    # I8: sub=0.20, harm2=0.25, p2=0.30, mh=3.50, 1500-3800
    # Suche: r > 0.78, max_diff < 3%
    tests = [
        # Basis
        (0.20, 0.25, 0.30, 0.20, 0.20, 3.50, 1500, 3500, "J1_H10"),
        (0.20, 0.25, 0.30, 0.20, 0.20, 3.50, 1500, 3800, "J2_I8"),
        # mh_hi sweep
        (0.20, 0.25, 0.30, 0.20, 0.20, 3.50, 1500, 3600, "J3_3600"),
        (0.20, 0.25, 0.30, 0.20, 0.20, 3.50, 1500, 3900, "J4_3900"),
        (0.20, 0.25, 0.30, 0.20, 0.20, 3.50, 1500, 4000, "J5_4000"),
        (0.20, 0.25, 0.30, 0.20, 0.20, 3.50, 1500, 4200, "J6_4200"),
        (0.20, 0.25, 0.30, 0.20, 0.20, 3.50, 1500, 4500, "J7_4500"),
        # Mit mh_lo 1400
        (0.20, 0.25, 0.30, 0.20, 0.20, 3.50, 1400, 3800, "J8_1400_3800"),
        (0.20, 0.25, 0.30, 0.20, 0.20, 3.50, 1400, 4000, "J9_1400_4000"),
        # Kombinatio
        (0.20, 0.25, 0.30, 0.20, 0.20, 3.60, 1500, 3800, "J10_MH36_1500_3800"),
    ]
    ...
    for sub, harm2, p2, vow, saw, mh, mh_lo, mh_hi, name in tests:
        ...
        out_wav = out_dir / f"synthese_v19_t25_{name}.wav"
