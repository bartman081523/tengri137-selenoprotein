"""
v18_phase34_beste_balance.py
V18 PHASE 34 — Beste Balance-Suche (Sub-Bass runter, Höhen-Mitten hoch)

LEHRE AUS PHASE 33:
- max_diff 10.0%, r=0.773
- 73.6% Sub-Bass (+10%), 1000-3000Hz -5.5% (zu wenig)

NEUE STRATEGIE:
- Sub-Bass: 0.40 (von 0.50)
- 2. Harmonische: 0.20
- Mitten-Rauschen 300-1500Hz: 0.40
- Mitten-Höhen-Rauschen 1500-3000Hz: 0.30 (NEU, füllt 1000-3000Hz)
- Centroid-Sinus: 0.20
- Höhen: 0.15
"""
import json
...
def main():
    print("=" * 80)
    print("V18 PHASE 34 — Beste Balance")
    print("=" * 80)
    ...
    out_wav = out_dir / "synthese_v34_beste_balance.wav"
    ...
    out_json = out_dir / "phase34_beste_balance.json"
    output = {
        "phase": "V18 Phase 34 — Beste Balance",
        "n_pass": n_pass,
        "n_tests": len(tests),
        "spektrum_r": float(r),
        ...
        "balance": {"sub": SUB_BASS_AMP, "harmonic": HARMONIC_AMP, "mid_noise": MID_NOISE_AMP, "mid_high_noise": MID_HIGH_NOISE_AMP, "centroid": CENTROID_AMP, "high": HIGH_AMP},
        "tests": tests,
        "verdict": f"V18 Phase 34: {n_pass}/{len(tests)} PASS. r={r:.3f}, wave_corr={wave_corr:.3f}, ratio={ratio:.3f}.",
    }
