"""
v18_phase31_mitten_erweitert.py
V18 PHASE 31 — Mitten-Band erweitert (300-1500Hz), Centroid lauter

LEHRE AUS PHASE 30:
- 70.6% Sub-Bass (gut, +7%), 9.4% in 300-1000Hz (ZU WENIG, -6.1%)

NEUE STRATEGIE:
- Sub-Bass: 0.40
- 2. Harmonische: 0.20
- Mitten-Rauschen 300-1500Hz (erweitert, 200-1500 war zu viel 100-300): 0.55
- Centroid-Sinus (lauter, füllt 300-1000Hz): 0.35
- Höhen: 0.10
"""
import json
import sys
...
def main():
    print("=" * 80)
    print("V18 PHASE 31 — Mitten-Band erweitert")
    print("=" * 80)
    ...
    # Mitten-Rauschen 300-1500Hz (erweitert)
    ...
    out_wav = out_dir / "synthese_v31_mitten_erweitert.wav"
    ...
    out_json = out_dir / "phase31_mitten_erweitert.json"
    output = {
        "phase": "V18 Phase 31 — Mitten-Band erweitert",
        "n_pass": n_pass,
        "n_tests": len(tests),
        "spektrum_r": float(r),
        ...
        "tests": tests,
        "verdict": f"V18 Phase 31: {n_pass}/{len(tests)} PASS. r={r:.3f}, wave_corr={wave_corr:.3f}, ratio={ratio:.3f}.",
    }
