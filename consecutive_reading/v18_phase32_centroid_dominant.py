"""
v18_phase32_centroid_dominant.py
V18 PHASE 32 — Centroid-Sinus dominant, Mitten-Rauschen reduziert

LEHRE AUS PHASE 31:
- Centroid ratio 0.514 (BESTE)
- 29.6% in 300-1000Hz (ZU VIEL)

NEUE STRATEGIE:
- Sub-Bass: 0.50 (vorher 0.40 — zu wenig)
- 2. Harmonische: 0.20
- Mitten-Rauschen: 0.30 (vorher 0.55 — zu viel)
- Centroid-Sinus: 0.40 (vorher 0.35)
- Höhen: 0.10
"""
import json
import sys
...
def main():
    print("=" * 80)
    print("V18 PHASE 32 — Centroid-Sinus dominant")
    print("=" * 80)
    ...
    out_wav = out_dir / "synthese_v32_centroid_dominant.wav"
    ...
    out_json = out_dir / "phase32_centroid_dominant.json"
    output = {
        "phase": "V18 Phase 32 — Centroid dominant",
        "n_pass": n_pass,
        "n_tests": len(tests),
        "spektrum_r": float(r),
        ...
        "tests": tests,
        "verdict": f"V18 Phase 32: {n_pass}/{len(tests)} PASS. r={r:.3f}, wave_corr={wave_corr:.3f}, ratio={ratio:.3f}.",
    }
