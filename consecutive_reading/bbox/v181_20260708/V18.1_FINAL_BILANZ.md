...
> **V18.1 BESTÄTIGT 2026-07-08 (p23 2D-Verifikation):** Stufe 27 Message-Hub-Verifikation hat V10.1 p23 als 2D-Notation identifiziert (11×14-Grid, 2 Lesarten). V18.1 Phase 2 nutzt BURUMUTREFAMTU als Segment 1 (row_ltr) — **konsistent mit V10.2-Korrektur**. Akrostichon BNYZTSOYNKS 11/11 in col_ttb Spalte 1 bestätigt. V18.1 KEINE Änderung nötig (BURUMUT-Slots 1-11 entsprechen Schmehs Original-Reihenfolge). Siehe `bbox/v22_20260708/v22_p23_2d_verification.json` (5/5 PASS).
...
**V10.2 KORREKTUR 2026-07-08:** V10.1 p23 english_text = row_rtl (Codierungsfehler). V10.2 korrigiert auf row_ltr (Schmehs Original-Reihenfolge). p23 ist 2D-Notation. V18.1 nutzt bereits korrekte Reihenfolge (BURUMUTREFAMTU = Segment 1).
