"""
test_v19_t8_tune.py
V19 PHASE 9 — T8_MH340 / T5_MH330 Bereich, 5/6 anvisieren

T5_MH330: sub=0.15, harm2=0.15, p2=0.20, didg=0.10, vow=0.20, saw=0.20, mh=3.30
   → r=0.744, ratio=0.864, max_diff=4.4%, 1-3k=8.6% (4/6 PASS)
T8_MH340: sub=0.15, harm2=0.15, p2=0.20, didg=0.10, vow=0.20, saw=0.20, mh=3.40
   → r=0.745, ratio=0.892, max_diff=4.3%, 1-3k=9.1% (4/6 PASS)

ZIEL: 5/6 durch 1-3k ≤ 8%
"""
import json
import sys
import numpy as np
...
def main():
    ...
    print("T8/T5 BEREICH (4/6 → 5/6 durch 1-3k ≤ 8%)")
    ...
    # Ziel: 1-3k unter 8%
    tests = [
        # T5_MH330 mit weniger saw (weniger 1-3k)
        (0.15, 0.15, 0.20, 0.10, 0.20, 0.15, 3.30, "T1_saw15"),
        (0.15, 0.15, 0.20, 0.10, 0.20, 0.10, 3.30, "T2_saw10"),
        # T5_MH330 mit weniger vow
        (0.15, 0.15, 0.20, 0.10, 0.15, 0.20, 3.30, "T3_vow15"),
        (0.15, 0.15, 0.20, 0.10, 0.10, 0.20, 3.30, "T4_vow10"),
        # T5_MH330 mit weniger didg
        (0.15, 0.15, 0.20, 0.05, 0.20, 0.20, 3.30, "T5_didg05"),
        (0.15, 0.15, 0.20, 0.00, 0.20, 0.20, 3.30, "T6_didg00"),
        # T5_MH330 mit mehr p2 (sub_bass reduzieren)
        (0.15, 0.15, 0.25, 0.10, 0.20, 0.20, 3.30, "T7_p2_25"),
        # T5_MH330 + sub 0.10
        (0.10, 0.15, 0.20, 0.10, 0.20, 0.20, 3.30, "T8_sub10"),
        (0.10, 0.15, 0.20, 0.10, 0.20, 0.20, 3.40, "T9_sub10_MH340"),
        (0.10, 0.15, 0.20, 0.10, 0.20, 0.20, 3.20, "T10_sub10_MH320"),
    ]
    ...
    for sub, harm2, p2, didg, vow, saw, mh, name in tests:
        ...
        out_wav = out_dir / f"synthese_v19_t9_{name}.wav"
