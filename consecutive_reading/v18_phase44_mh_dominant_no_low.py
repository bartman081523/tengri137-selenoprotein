"""
v18_phase44_mh_dominant_no_low.py
V18 PHASE 44 — MH-Rauschen dominant, weniger Sub-Bass

LEHRE AUS PHASE 41/43:
- 3/5 PASS, max_diff 2.6%
- Centroid ratio 0.614 (ZU NIEDRIG wegen zu viel Sub-Bass)

ZIEL: Sub-Bass reduzieren, MH-Rauschen erhöhen
- Sub-Bass: 0.35 → 0.20
- 2. Harmonische: 0.15 → 0.10
- Mitten-Rauschen: 0.30 → 0.40
- MH-Rauschen: 1.20 → 1.50
- Centroid: 0.20 → 0.30
- Höhen: 0.40
"""
import json
...
def main():
    print("=" * 80)
    print("V18 PHASE 44 — MH-Rauschen dominant")
    print("=" * 80)
    ...
    out_wav = out_dir / "synthese_v44_mh_dom.wav"
    ...
    out_json = out_dir / "phase44_mh_dom.json"
    output = {
        "phase": "V18 Phase 44 — MH dominant",
        "n_pass": n_pass,
        "n_tests": len(tests),
        "spektrum_r": float(r),
        ...
        "tests": tests,
        "verdict": f"V18 Phase 44: {n_pass}/{len(tests)} PASS. r={r:.3f}, wave_corr={wave_corr:.3f}, ratio={ratio:.3f}.",
    }
