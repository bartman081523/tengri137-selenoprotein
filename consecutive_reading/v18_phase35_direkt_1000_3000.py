"""
v18_phase35_direkt_1000_3000.py
V18 PHASE 35 — Mitten-Höhen-Rauschen direkt in 1000-3000Hz

LEHRE AUS PHASE 34:
- max_diff 6.1% (BEST)
- 0.3% in 1000-3000Hz (1500-3000Hz-Rauschen erzeugt kaum Power)

NEUE STRATEGIE:
- Mitten-Höhen-Rauschen DIREKT in 1000-3000Hz (volle Bandbreite)
- Stärkere Amplitude
"""
import json
import sys
...
def main():
    print("=" * 80)
    print("V18 PHASE 35 — Mitten-Höhen-Rauschen 1000-3000Hz")
    print("=" * 80)
    ...
    HARMONIC_AMP = 0.20
    MID_NOISE_AMP = 0.40
    MID_HIGH_NOISE_AMP = 0.50  # VIEL stärker
    CENTROID_AMP = 0.20
    HIGH_AMP = 0.20

    # Mitten-Rauschen 300-1000Hz
    print("Generiere Mitten-Rauschen (300-1000Hz)...")
    ...
    # Mitten-Höhen-Rauschen 1000-3000Hz (DIREKT)
    ...
    out_wav = out_dir / "synthese_v35_mh_direkt.wav"
    ...
    out_json = out_dir / "phase35_mh_direkt.json"
    output = {
        "phase": "V18 Phase 35 — MH-Rauschen direkt 1000-3000Hz",
        "n_pass": n_pass,
        "n_tests": len(tests),
        "spektrum_r": float(r),
        ...
        "tests": tests,
        "verdict": f"V18 Phase 35: {n_pass}/{len(tests)} PASS. r={r:.3f}, wave_corr={wave_corr:.3f}, ratio={ratio:.3f}.",
    }
