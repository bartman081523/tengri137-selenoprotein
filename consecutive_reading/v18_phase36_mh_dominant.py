"""
v18_phase36_mh_dominant.py
V18 PHASE 36 — Mitten-Höhen dominant (1000-3000Hz hoch)

LEHRE AUS PHASE 35:
- 1000-3000Hz erzeugt nur 0.5% trotz AMP 0.50 (von 0.30)

NEUE STRATEGIE:
- Mitten-Höhen-Rauschen 1000-3000Hz: 1.5 (VIEL stärker als 0.5)
- Sub-Bass reduzieren
"""
import json
import sys
...
def main():
    print("=" * 80)
    print("V18 PHASE 36 — Mitten-Höhen dominant (1000-3000Hz)")
    print("=" * 80)
    ...
    # KRITISCH: Mitten-Höhen VIEL stärker
    SUB_BASS_AMP = 0.30
    HARMONIC_AMP = 0.15
    MID_NOISE_AMP = 0.50
    MID_HIGH_NOISE_AMP = 1.20  # DOMINANT
    CENTROID_AMP = 0.20
    HIGH_AMP = 0.20
    ...
    out_wav = out_dir / "synthese_v36_mh_dominant.wav"
    ...
    out_json = out_dir / "phase36_mh_dominant.json"
    output = {
        "phase": "V18 Phase 36 — Mitten-Höhen dominant",
        "n_pass": n_pass,
        "n_tests": len(tests),
        "spektrum_r": float(r),
        ...
        "tests": tests,
        "verdict": f"V18 Phase 36: {n_pass}/{len(tests)} PASS. r={r:.3f}, wave_corr={wave_corr:.3f}, ratio={ratio:.3f}.",
    }
