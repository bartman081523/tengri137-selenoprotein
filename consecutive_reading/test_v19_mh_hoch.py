"""
test_v19_mh_hoch.py
V19 PHASE 20 — MH-Band höher angesetzt (1500-3000 statt 1000-3000)

PROBLEM: ratio < 0.85 ↔ 1-3k > 8% reziprok
LÖSUNG: 1-3k enger fassen (1500-3000), mehr Anteil in 3-8k
   → weniger 1-3k, höhere ratio
"""
import json
import sys
import numpy as np
...
def main():
    ...
    print("MH-BAND VERSCHOBEN (höherer lo, höherer hi)")
    print(f"{'Name':<35} {'r':<7} {'wave':<10} {'ratio':<7} {'diff':<8} {'0-100':<8} {'1-3k':<8}")
    print("-" * 100)

    # Standard: sub=0.20, harm2=0.20, p2=0.30, vow=0.20, saw=0.20, mh=3.20
    # Versuche: MH-Band von 1500-3500 statt 1000-3000
    tests = [
        # Original
        (0.20, 0.20, 0.30, 0.20, 0.20, 3.20, 1000, 3000, "E1_orig_MH_1k_3k"),
        # Höher
        (0.20, 0.20, 0.30, 0.20, 0.20, 3.20, 1500, 3000, "E2_MH_1500_3000"),
        (0.20, 0.20, 0.30, 0.20, 0.20, 3.20, 1500, 3500, "E3_MH_1500_3500"),
        (0.20, 0.20, 0.30, 0.20, 0.20, 3.20, 2000, 4000, "E4_MH_2000_4000"),
        (0.20, 0.20, 0.30, 0.20, 0.20, 3.20, 2000, 5000, "E5_MH_2000_5000"),
        # Mit höherem MH-Wert
        (0.20, 0.20, 0.30, 0.20, 0.20, 3.50, 1500, 3000, "E6_MH_1500_3000_35"),
        (0.20, 0.20, 0.30, 0.20, 0.20, 3.50, 1500, 3500, "E7_MH_1500_3500_35"),
        (0.20, 0.20, 0.30, 0.20, 0.20, 4.00, 1500, 3500, "E8_MH_1500_3500_40"),
        (0.20, 0.20, 0.30, 0.20, 0.20, 4.00, 2000, 4000, "E9_MH_2000_4000_40"),
        # Auch p2 runter
        (0.20, 0.20, 0.20, 0.20, 0.20, 3.50, 1500, 3500, "E10_p2_20_MH_1500_3500"),
    ]
    ...
    for sub, harm2, p2, vow, saw, mh, mh_lo, mh_hi, name in tests:
        ...
        out_wav = out_dir / f"synthese_v19_t20_{name}.wav"
