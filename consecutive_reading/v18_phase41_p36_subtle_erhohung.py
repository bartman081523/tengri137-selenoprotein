"""
v18_phase41_p36_subtle_erhohung.py
V18 PHASE 41 — Phase 36 (3/5) mit Sub-Bass +0.05
...
ZIEL: Sub-Bass 0.30 → 0.35, sonst identisch zu Phase 36
"""
import json
import sys
import numpy as np
...
def main():
    print("=" * 80)
    print("V18 PHASE 41 — Phase 36 + Sub-Bass +0.05")
    print("=" * 80)
    ...
    out_wav = out_dir / "synthese_v41_p36_sub_hoch.wav"
    ...
    out_json = out_dir / "phase41_p36_sub_hoch.json"
    output = {
        "phase": "V18 Phase 41 — Phase 36 + Sub-Bass",
        "n_pass": n_pass,
        "n_tests": len(tests),
        "spektrum_r": float(r),
        ...
        "tests": tests,
        "verdict": f"V18 Phase 41: {n_pass}/{len(tests)} PASS. r={r:.3f}, wave_corr={wave_corr:.3f}, ratio={ratio:.3f}.",
    }
