...
class TestBurumutPhases:
    ...
    def test_ganzer_text_mit_fragezeichen_google_translate(self):
        ...
        import json
        from pathlib import Path
        path = Path(__file__).parent.parent / "burumut" / "burumut_google_translate.json"
        with open(path) as f:
            data = json.load(f)
        # Mit Fragezeichen
    ...
    def test_komplette_sechs_phasen_uebersetzung(self):
        ...
        import json
        from pathlib import Path
        path = Path(__file__).parent.parent / "burumut" / "burumut_complete_translation.json"
        with open(path) as f:
            data = json.load(f)
    ...
    def test_burumut_phonetische_tajpala_alle_phasen(self):
        ...
        import json
        from pathlib import Path
        path = Path(__file__).parent.parent / "burumut" / "burumut_phonetic_translation.json"
        with open(path) as f:
            data = json.load(f)
    ...
    def test_burumut_tengri137_integration(self):
        ...
        import json
        from pathlib import Path
        path = Path(__file__).parent.parent / "burumut" / "burumut_tengri137_translation.json"
        with open(path) as f:
            data = json.load(f)
